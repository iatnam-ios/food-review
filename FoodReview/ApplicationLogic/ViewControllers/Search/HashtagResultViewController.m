...
@interface HashtagResultViewController ()<UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
...
@implementation HashtagResultViewController
...
- (void)searchResult {
    if (self.searchText.length > 0) {
        ...
        self.query = [[self.db collectionWithPath:@"reviews"] queryWhereField:@"hashtags" arrayContains:self.searchText];
